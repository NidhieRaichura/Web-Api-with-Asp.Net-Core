...
namespace H_Plus_Sports.Models
{
    public partial class H_Plus_SportsContext : DbContext
    {
        ...
        //                optionsBuilder.UseSqlServer("Server=tcp:hsportsraichura.database.windows.net,1433;Initial Catalog=H_Plus_Sports;Persist Security Info=False;User ID=Nidhie;Password=Localhost:4200;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        //            }
        //        }
